...
public class Main {
    ...
    private static void exercise2() {
        ...
        while (remainingPoundsToSell > 0){
            if (poundToEuroExchangeRate > 1.15){
                remainingPoundsToSell = remainingPoundsToSell - 1_000;
                daysToSell++;
     ...
     * A1:DO WHILE perchè vogliamo che almeno una azione sia svolta dall'utente
     *
     * Q2: We have a list of 1000 users to send emails to
     * A2:FOR EACH perchè abbiamo un numero già prestabilito di users
     *
     * Q3: We want to print out the first 80 customer names from our bank database
     * A3:for i perchè abbiamo una condizione per far feramre il ciclo
     *
