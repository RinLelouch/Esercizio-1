...
public class Main {
    ...
    public static void exercise2() {
        ...
        menuItems.add("Parmigiana");
        menuItems.add("Pizza");
        menuPrices.add(15.80);
        menuPrices.add(10.25);
        menuPrices.add(8.89);
        System.out.println("item= "+ menuItems.get(0) + ',' + "price= " + menuPrices.get(0));
        System.out.println("item= "+ menuItems.get(1) + ',' + "price= " + menuPrices.get(1));
        System.out.println("item= "+ menuItems.get(2) + ',' + "price= " + menuPrices.get(2));
        //Write your code here
    }
    ...
    public static void exercise3() {
        ...
        totalSum = items[0]+items[1]+items[2]+items[3]+items[4]+items[5]+items[6]+items[7]+items[8]+items[9];
