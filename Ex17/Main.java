...
public class Main {
    ...
    private static void exercise1() {
        ...
        long totalBalanceInEuro = myBankBalanceEuro + questionableFundsEuro;
        System.out.println(totalBalanceInEuro);
     ...
     *    2d: Price of a good in euros on amazon.com   DOUBLE
    ...
    public static void exercise3() {
        ...
        LocalDate comparisionDate = LocalDate.of(1990 , 12 , 3);
        System.out.println( localDate.isBefore(comparisionDate));
        System.out.println(localDate.isAfter(comparisionDate));
    }
}
