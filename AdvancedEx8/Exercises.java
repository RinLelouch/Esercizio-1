...
public class Exercises {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1: ");
        // Your code here
        Dog dog=new Dog(12.0,30.0,"Carlino");
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3: ");
        // Your code here
        Dog dog=new Dog(12.0 ,20.0 , "Jack Russel");
        FIsh fish = new FIsh(13.0, 22.0, "Salmone");
        Bird bird= new Bird(10.0, 11.0, 12.0);
        double maxSpeed = Math.max(Math.max(dog.runSpeedMetersPerSecond(), fish.swimSpeedMetersPerSecond()), bird.flySpeedMetersPerSecond());
