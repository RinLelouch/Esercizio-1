...
public class Main {
    ...
    private static void exercise3() {
        ...
        String booleanStrToConvert = "22222"; // And this line
    ...
    private static void exercise4() {
        ...
        double startAsDouble = Double.valueOf(startStr);
        startAsDouble /= 3.5;
        startAsDouble=Math.floor(startAsDouble);


        System.out.println(startAsDouble);}
