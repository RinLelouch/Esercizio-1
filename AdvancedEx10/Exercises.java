...
public class Exercises {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1: ");
        // Your code here
        Person person = new Person("Andrea", 25, "Via Cavalli di Bronzo" );
    ...
    private static void exercise2() {
        ...
        // Your code here
        Person person = new Person("Andrea", 25, "Via Cavalli di Bronzo" );
        Person person1 = new Person("Giovanni", 25, "Via Asini di Bronzo" );
        Person person2 = new Person("Andrea", 23, "Via giuseppe di Bronzo" );
